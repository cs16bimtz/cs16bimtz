...
## PARÂMETROS DE CONFIGURAÇÃO UTILIZADOS:
 ABA DE DADOS DO FORMULÁRIO        |            CAMPO FORMULÁRIO         |                 RITÉRIO               | STATUS            | OBS |
-----------------------------------|-------------------------------------|---------------------------------------|-------------------|-----|
 ...
 DADOS PESSOAIS                    | VOLUNTÁRIO                          | Solteiro                              | INDICADO          |     |
 PERFIL SOCIOECONÔMICO             | MORA COM QUEM NO ENDEREÇO DECLARADO | Solteiro                              | INDICADO          |     |
 PERFIL SOCIOECONÔMICO             | EM CASO DE CONVOCAÇÃO               | Solteiro                              | INDICADO          |     |
 PERFIL SOCIOECONÔMICO             | ARRIMO DE FAMÍLIA                   | Solteiro                              | INDICADO          |     |
 PERFIL SOCIOECONÔMICO             | PASSAGEM PELA POLÍCIA               | Solteiro                              | INDICADO          |     |
 PERFIL SOCIOECONÔMICO             | EXPERIÊNCIA COM DROGAS              | Solteiro                              | INDICADO          |     |
