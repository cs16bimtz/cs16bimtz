...
O sistema possui as configurações necessárias para garantir que todos os conscritos selecionados para a incorporação, atendam aos requisitos que a unidade deseja. Para que o conscrito seja considerado <kdb>indicado</kdb> na entrevista, uma série de requisitos devem ser satisfeitos; para que o conscrito seja <kdb>Contraindicado</kdb> na fase de entrevista, todavia, basta que apenas um dos parâmetros (requisitos) não seja atendido. Essas características do sistema garantem o rigor e a homogeneidade do processo seletivo. 
