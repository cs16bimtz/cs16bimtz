...
- Durante a análise dos dados coletados (fase pós CS) e antes da divulgação dos resultado do processo seletivo, utilizando a ferramenta de busca avançada já disponível no sistema, será possível a realização de consultas como a do exemplo:
